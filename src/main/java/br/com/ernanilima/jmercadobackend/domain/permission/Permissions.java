        ...
        MENU_REGISTRATION(1000, USER, "ROLE_MENU_REGISTRATION", I18n.getMessage(I18n.ROLE_MENU_REGISTRATION)),
            MENU_REGISTRATION_FOR_USER(1200, MENU_REGISTRATION, "ROLE_MENU_REGISTRATION_FOR_USER", I18n.getMessage(I18n.ROLE_MENU_REGISTRATION_FOR_USER)),
                MENU_REGISTRATION_USER(1201, MENU_REGISTRATION_FOR_USER, "ROLE_MENU_REGISTRATION_USER", I18n.getMessage(I18n.ROLE_MENU_REGISTRATION_USER)),
                    REGISTRATION_USER_FIND(1202, MENU_REGISTRATION_USER, "ROLE_REGISTRATION_USER_FIND", I18n.getMessage(I18n.ROLE_REGISTRATION_USER_FIND)),
                    REGISTRATION_USER_INSERT(1203, MENU_REGISTRATION_USER, "ROLE_REGISTRATION_USER_INSERT", I18n.getMessage(I18n.ROLE_REGISTRATION_USER_INSERT)),
                    REGISTRATION_USER_UPDATE(1204, MENU_REGISTRATION_USER, "ROLE_REGISTRATION_USER_UPDATE", I18n.getMessage(I18n.ROLE_REGISTRATION_USER_UPDATE)),
                    REGISTRATION_USER_DELETE(1205, MENU_REGISTRATION_USER, "ROLE_REGISTRATION_USER_DELETE", I18n.getMessage(I18n.ROLE_REGISTRATION_USER_DELETE)),
                MENU_REGISTRATION_USER_GROUP(1211, MENU_REGISTRATION_FOR_USER, "ROLE_MENU_REGISTRATION_USER_GROUP", I18n.getMessage(I18n.ROLE_MENU_REGISTRATION_USER_GROUP)),
                    REGISTRATION_USER_GROUP_FIND(1212, MENU_REGISTRATION_USER_GROUP, "ROLE_REGISTRATION_USER_GROUP_FIND", I18n.getMessage(I18n.ROLE_REGISTRATION_USER_GROUP_FIND)),
                    REGISTRATION_USER_GROUP_INSERT(1213, MENU_REGISTRATION_USER_GROUP, "ROLE_REGISTRATION_USER_GROUP_INSERT", I18n.getMessage(I18n.ROLE_REGISTRATION_USER_GROUP_INSERT)),
                    REGISTRATION_USER_GROUP_UPDATE(1214, MENU_REGISTRATION_USER_GROUP, "ROLE_REGISTRATION_USER_GROUP_UPDATE", I18n.getMessage(I18n.ROLE_REGISTRATION_USER_GROUP_UPDATE)),
                    REGISTRATION_USER_GROUP_DELETE(1215, MENU_REGISTRATION_USER_GROUP, "ROLE_REGISTRATION_USER_GROUP_DELETE", I18n.getMessage(I18n.ROLE_REGISTRATION_USER_GROUP_DELETE)),
            ...
            MENU_REGISTRATION_COMPANY(1230, MENU_REGISTRATION, "ROLE_MENU_REGISTRATION_COMPANY", I18n.getMessage(I18n.ROLE_MENU_REGISTRATION_COMPANY)),
                REGISTRATION_COMPANY_FIND(1231, MENU_REGISTRATION_COMPANY, "ROLE_REGISTRATION_COMPANY_FIND", I18n.getMessage(I18n.ROLE_REGISTRATION_COMPANY_FIND)),
                REGISTRATION_COMPANY_INSERT(1232, MENU_REGISTRATION_COMPANY, "ROLE_REGISTRATION_COMPANY_INSERT", I18n.getMessage(I18n.ROLE_REGISTRATION_COMPANY_INSERT)),
                REGISTRATION_COMPANY_UPDATE(1233, MENU_REGISTRATION_COMPANY, "ROLE_REGISTRATION_COMPANY_UPDATE", I18n.getMessage(I18n.ROLE_REGISTRATION_COMPANY_UPDATE)),
                REGISTRATION_COMPANY_DELETE(1234, MENU_REGISTRATION_COMPANY, "ROLE_REGISTRATION_COMPANY_DELETE", I18n.getMessage(I18n.ROLE_REGISTRATION_COMPANY_DELETE));
